            ...
            if ("undefined" != typeof document) {
                if (arguments.length > 1) {
                    if ("number" == typeof (i = e({
                        ...
                        var a = new Date;
                        a.setMilliseconds(a.getMilliseconds() + 86400000 * i.expires), i.expires = a
                    }
            ...
            if (o(t).hasClass("google")) {
                ...
                if (o(t).hasClass("bing")) {
                    ...
                    if (o(t).hasClass("image")) {
                        ...
                        if (o(t).hasClass("DuckGo")) {
                            o(".search-form").attr("action", "https://duckduckgo.com/"), o(".search-keyword").attr({
                                name: "q",
                                placeholder: "DuckDuckGo"
                            })
                        } else {
                            if (o(t).hasClass("torrent")) {
                                o(".search-form").attr("action", "https://torrentz2.eu/search"), o(".search-keyword").attr({
                                    name: "f",
                                    placeholder: "磁力链，种子搜索"
                                })
                            } else {
                                if (o(t).hasClass("scholar")) {
